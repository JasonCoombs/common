...
namespace bs {
   ...
   public:
      ...
      std::shared_ptr<Armory::Signer::ScriptRecipient> getRecipient(const XBTAmount& amount) const;
      ...
      static bs::Address fromRecipient(const std::shared_ptr<Armory::Signer::ScriptRecipient> &);
