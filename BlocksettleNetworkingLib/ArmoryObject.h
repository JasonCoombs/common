...
public:
   ...
   bool getTxByHash(const BinaryData &hash, const TxCb &, bool allowCachedResult) override;
   bool getTXsByHash(const std::set<BinaryData> &hashes, const TXsCb &, bool allowCachedResult) override;
