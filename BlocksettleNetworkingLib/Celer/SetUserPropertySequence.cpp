...
SetUserPropertySequence::SetUserPropertySequence(const std::shared_ptr<spdlog::logger>& logger
      , const std::string& username
      , const Property& property)
 : CommandSequence("CelerSetUserPropertySequence",
   {
      { false, nullptr, &SetUserPropertySequence::sendSetPropertyRequest },
      { true, &SetUserPropertySequence::processSetPropertyResponse, nullptr }
   })
 , logger_(logger)
 , userName_(username)
 , property_(property)
...
CelerMessage SetUserPropertySequence::sendSetPropertyRequest()
{
...
bool SetUserPropertySequence::processSetPropertyResponse(const CelerMessage& message)
{
