...
namespace bs {
   namespace celer {
      ...
      template<class _C>
      class CommandSequence : public BaseCelerCommand
      {
      public:
      ...
      public:
         CommandSequence(const std::string& name, const std::vector<SequenceStep>& steps)
         ...
         ~CommandSequence() noexcept override = default;
